...
function P2PoolDonationButton(parameters) {
    ...
    this.create = function () {
        ...
        $(style).append(this.id + " .P2PoolDonationButton-container {display:inline-block;font-size:11pt;text-align:left;}");
        $(style).append(this.id + " .P2PoolDonationButton-container * {font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;text-decoration:none;line-height:normal;}");
        $(style).append(this.id + " .P2PoolDonationButton-border {border:1px solid grey;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon-shadow {display:none;position:fixed;z-index:1000;top:0px;left:0px;width:100%;height:100%;margin:0px;justify-content:center;align-items:center;background:rgba(0,0,0,0.8);}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon-shadow.P2PoolDonationButton-show {display:flex;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon {position:relative;width:380pt;height:60%;padding:20px;color:black;background:white;box-shadow:5px 5px 20px #050505;-webkit-box-shadow:5px 5px 20px #050505;-moz-box-shadow:5px 5px 20px #050505;overflow:auto;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-button {display:block;margin:4px;padding:4px 6px 4px 6px;color:white;background:#f7931a;text-decoration:none;font-weight:bold;box-shadow:2px 2px 6px grey;-webkit-box-shadow:2px 2px 6px grey;-moz-box-shadow:2px 2px 6px grey;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-button:hover, " + this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-button:focus {color:white;background:#f75c1a;text-decoration:none;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon .P2PoolDonationButton-close {font-size:16pt;font-weight:bold;position:absolute;top:8pt;right:8pt;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon h3 {font-size:14pt;font-weight:bold;margin:1em 0em 1em 0em;color:black;background:transparent;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon p {margin:1em 0em 1em 0em;color:black;background:transparent;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon a {color:#1a7ef7;background:transparent;border:none;} " + this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon a:hover, " + this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon a:focus {color:#072cbe;background:transparent;text-decoration:none;border:none;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon img {border:none;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon label {display:block;font-size:9pt;font-weight:bold;color:black;background:transparent;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon input {display:block;width:60%;margin:auto;padding:4px;color:black;background:white;text-align:center;font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;font-size:12pt;border:2px solid black;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon table {border-collapse:collapse;width:100%;text-align:left;border:none;color:black;background:transparent;}");
        $(style).append(this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon table td {text-align:left;border:none;} " + this.id + " .P2PoolDonationButton-container .P2PoolDonationButton-balloon table th {font-weight:bold;text-align:left;border:none;}");
